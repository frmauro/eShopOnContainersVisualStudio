...
{
    private readonly Func<DbConnection, IntegrationEventLogEF.Services.IIntegrationEventLogService> _integrationEventLogServiceFactory;
    private readonly IEventBus _eventBus;
    private readonly CatalogContext _catalogContext;
    private readonly IntegrationEventLogEF.Services.IIntegrationEventLogService _eventLogService;
    ...
    public CatalogIntegrationEventService(
        ...
        Func<DbConnection, IntegrationEventLogEF.Services.IIntegrationEventLogService> integrationEventLogServiceFactory)
    {
